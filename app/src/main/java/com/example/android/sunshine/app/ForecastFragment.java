...
/**
 * Created by SudharsanPrabu on 9/1/16.
 */
public class ForecastFragment extends Fragment {

    private ArrayAdapter<String> SunshineAdapter;
    ...
    public class FetchWeatherTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                String baseUrl = "http://api.openweathermap.org/data/2.5/forecast/daily?q=98033&mode=json&units=metric&cnt=7";
